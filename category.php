...
<i class="fa-solid fa-circle-info"></i><a href="home.php">&nbsp;Home&nbsp;</a><i class="fa-solid fa-chevron-right"></i><a href="shop.php">&nbsp;Shop&nbsp;</a><i class="fa-solid fa-chevron-right"></i>&nbsp;Category
   </span></div>
...
<form action="" method="post" class="box">
   <div class="copy" style="inline-size: max-content;
    ...
    font-size: medium;"><p><?= $fetch_product['quality']; ?></p></div>
      ...
      <div class="name" style="text-transform:capitalize"><?= $fetch_product['name']; ?></div>
      <div class="flex">
