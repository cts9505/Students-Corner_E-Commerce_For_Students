...
if(isset($_POST['update'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?,quantity=?,category=?, price = ?, details = ? WHERE id = ?");
...
<section class="update-product"  style="text-transform: capitalize;">
   ...
   <form action="" method="post" enctype="multipart/form-data"  style="text-transform: capitalize;">
      ...
      <span class="details" style="text-transform: capitalize;color:black;">Sold by : <?= $fetch_products['sold_by']; ?></div><br><br>
      ...
      <div class="flex-btn">
         ...
         <a href="live_products.php" class="option-btn">Go back</a>
      </div>
   </form>
