...
if(isset($_GET['status'])){
    ...
    $status_product = $conn->prepare(" UPDATE `lostnfound` SET status='Found', recieved_by='Students Corner (admin)' WHERE id = ?");
    $status_product->execute([$status_id]);
    $message[] = 'Item status updated ! Recieved sucessfully  ';
...
if(isset($_GET['delete'])){
   ...
   $delete_product_image = $conn->prepare("SELECT * FROM `lostnfound` WHERE id = ?");
   $delete_product_image->execute([$delete_id]);
   $fetch_delete_image = $delete_product_image->fetch(PDO::FETCH_ASSOC);
   unlink('../lostandfound/'.$fetch_delete_image['image_01']);
   $delete_product = $conn->prepare("DELETE FROM `lostnfound` WHERE id = ?");
...
<i class="fa-solid fa-circle-info"></i><a href="dashboard.php">&nbsp;Home&nbsp;</a><i class="fa-solid fa-chevron-right"></i>&nbsp;Lost And Found
   ...
   <form action="" method="post" style="font-size:large">
      ...
      <div >
        ...
        <input type="hidden" value="<?= $fetch_product['id']; ?>" name="id">
         ...
         <a href="lost_found.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn"  onclick="return confirm('Cofirm delete?');">Delete</a>
   ...
   <div class="box"> <form action="" method="POST">
      ...
      <div >
        ...
        <input type="hidden" value="<?= $fetch_products['id']; ?>" name="id">
         ...
         <a href="lost_found.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn"  onclick="return confirm('Confirm delete?');">Delete</a>
