...
<i class="fa-solid fa-circle-info"></i><a href="home.php">&nbsp;Home&nbsp;</a><i class="fa-solid fa-chevron-right"></i>&nbsp;Wishlist
   </span></div>
   ...
   <form action="" method="post" class="box">
      ...
      <input type="hidden" name="name" style="    text-transform: capitalize;" value="<?= $fetch_wishlist['name']; ?>">
      ...
      while($fetch=mysqli_fetch_assoc($select)){
         ?>
         <input type="number" name="qty" class="qty" min="1" max="<?= $fetch['quantity'];} ?>" onkeypress="if(this.value.length == 2) return false;" value="1">
      </div>
