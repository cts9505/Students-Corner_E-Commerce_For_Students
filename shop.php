...
<i class="fa-solid fa-circle-info"></i><a href="home.php">&nbsp;Home&nbsp;</a><i class="fa-solid fa-chevron-right"></i>&nbsp;Shop
   </span></div>
   ...
   <div class="copy" style="inline-size: max-content;  margin-left: 24.7rem; background: lime;  padding: 1rem 2.5rem 1rem 1rem;
    border-radius: 5rem;font-size: medium;"><p><?= $fetch_product['quality']; ?></p></div>
